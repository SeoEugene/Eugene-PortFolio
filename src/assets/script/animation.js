document.addEventListener("DOMContentLoaded", function () {
    ...
    // contact lodding
    // let contactLeft = document.querySelector(".contact__left");
    // let contactRight = document.querySelector(".contact__right");
    // contactLeft.classList.add("loaded");
    // contactRight.classList.add("loaded");
});